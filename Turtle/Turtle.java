...
public class Turtle {
  ...
  public void drawEquiTriangle(int sideLength) {
  ...
  public void drawNGon(int numOfSides, int sideLength) {
    for (int count = 0; count < numOfSides; count++) {
      forward(sideLength);
      turnRight(360 / numOfSides);
    }
  }
}